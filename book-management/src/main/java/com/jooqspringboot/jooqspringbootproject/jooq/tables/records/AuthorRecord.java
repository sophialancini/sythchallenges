...
public class AuthorRecord extends UpdatableRecordImpl<AuthorRecord> implements Record5<Integer, String, String, LocalDate, Byte> {
    ...
    private static final long serialVersionUID = 416136975;

    /**
     * Setter for <code>author.idauthor</code>.
     */
    ...
    /**
     * Getter for <code>author.idauthor</code>.
     */
     ...
     */
    public AuthorRecord(Integer idauthor, String firstName, String lastName, LocalDate dateOfBirth, Byte distinguished) {
        super(Author.AUTHOR);
