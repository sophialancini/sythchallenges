...
public class Author extends TableImpl<AuthorRecord> {
    ...
    private static final long serialVersionUID = 1967664207;
    ...
    /**
     * The column <code>author.idauthor</code>.
     */
    public final TableField<AuthorRecord, Integer> IDAUTHOR = createField(DSL.name("idauthor"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<AuthorRecord, String> LAST_NAME = createField(DSL.name("last_name"), org.jooq.impl.SQLDataType.VARCHAR(50), this, "");
